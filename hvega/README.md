...
[![vega-lite version](https://img.shields.io/badge/Vega--Lite-v4.9-purple.svg)](https://vega.github.io/vega-lite/)

Create [Vega-Lite](https://vega.github.io/vega-lite/) visualizations in
Haskell. It targets version 4.9 of the Vega-Lite specification. Note that
